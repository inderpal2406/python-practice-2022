"""Module to find maximum of 2 numbers"""
...
def main():
    ...
    print("This script will accept 2 nums & display greatest of the two.\n")
    try:
    ...
    numlist.sort()
    #print(numlist)
    print(f"The maximum number amongst {num1} & {num2} is: {numlist[-1]}\n")
    return None
